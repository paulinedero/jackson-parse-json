...
public class Parse {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Double cityLatitude = root.path("coord").path("lat").asDouble();
            Double cityLongitude = root.path("coord").path("lon").asDouble();

            // TODO : get the "wind" attribute as an Wind object
            Wind wind = objectMapper.treeToValue(root.path("wind"), Wind.class);

            // TODO : get the "weather" attribute as an array of Weather objects
            Weather[] weathers = objectMapper.treeToValue(root.path("weather"), Weather[].class);
